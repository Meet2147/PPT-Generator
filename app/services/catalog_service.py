...
def get_subscription_catalog() -> list[SubscriptionPlan]:
    return [
        SubscriptionPlan(
            ...
            price_monthly=299,
            price_annual=2999,
            monthly_presentation_cap=20,
            annual_monthly_presentation_cap=20,
            ...
            features=[
                ...
                FeatureItem(label="Up to 20 presentations per month", emphasis=True),
                FeatureItem(label="Annual billing keeps the same 20 presentations per month cap"),
        ...
        SubscriptionPlan(
            ...
            price_monthly=799,
            price_annual=7999,
            monthly_presentation_cap=75,
            annual_monthly_presentation_cap=75,
            ...
            features=[
                ...
                FeatureItem(label="Up to 75 presentations per month", emphasis=True),
                FeatureItem(label="Annual billing keeps the same 75 presentations per month cap"),
        ...
        SubscriptionPlan(
            ...
            price_monthly=1799,
            price_annual=17999,
            monthly_presentation_cap=200,
            annual_monthly_presentation_cap=200,
            ...
            features=[
                ...
                FeatureItem(label="Up to 200 presentations per month", emphasis=True),
                FeatureItem(label="Annual billing keeps the same 200 presentations per month cap"),
