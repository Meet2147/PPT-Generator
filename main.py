...
async def generate_presentation_from_pdf(file: UploadFile = File(...)):
    try:
        ...
        return FileResponse(presentation_path, filename="presentation_from_pdf.pptx", media_type='application/vnd.openxmlformats-officedocument.presentationml.presentation')
    except Exception as e:
        raise HTTPException(status_code=500, detail=str(e))
